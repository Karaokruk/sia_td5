...
public:
    ...
    void setPerspective(float fovY, float nearDist, float farDist);
    //------------------------------------------------------------
    ...
    unsigned int sampleCount() const { return mSampleCount;}
    void setSampleCount(unsigned int s) { mSampleCount = s; }
